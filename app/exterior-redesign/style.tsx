...
const designStyles = [
    ...
    { id: "traditional", name: "Geleneksel", emoji: "🏛️" },
    { id: "mediterranean", name: "Akdeniz", emoji: "🌊" },
    { id: "colonial", name: "Kolonyal", emoji: "🏘️" },
    ...
    return (
        <SafeAreaView className="flex-1 bg-background">
            <View className="flex-row items-center justify-between px-4 py-3">
                ...
                <Text className="text-lg font-semibold text-foreground">Dış Cephe Stili</Text>
            ...
            <ScrollView className="flex-1" contentContainerClassName="px-4 pb-32" showsVerticalScrollIndicator={false}>
                ...
                <Text className="text-base font-semibold text-foreground mb-4">Stil Seçin</Text>
