...
const designStyles = [
    ...
    { id: "luxury", name: "Lüks", emoji: "✨" },
];

export default function FurnitureStyleScreen() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-background">
            <View className="flex-row items-center justify-between px-4 py-3">
                ...
                <Text className="text-lg font-semibold text-foreground">Mobilya Stili</Text>
            ...
            <ScrollView className="flex-1" contentContainerClassName="px-4 pb-32" showsVerticalScrollIndicator={false}>
                ...
                <Text className="text-base font-semibold text-foreground mb-4">Mobilya Stili Seçin</Text>
            ...
            <View className="absolute bottom-0 left-0 right-0 bg-background px-4 pb-8 pt-4">
                <PillButton onPress={() => router.push({ pathname: "/loading", params: { action: "furniture" } })} disabled={!selectedStyle} fullWidth size="lg" icon={<Ionicons name="sparkles" size={20} color="#FFFFFF" />}>
                    Oluştur (8 Kredi)
                </PillButton>
            </View>
        </SafeAreaView>
