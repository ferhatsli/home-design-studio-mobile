...
const designStyles = [
    ...
    { id: "japanese", name: "Japon", emoji: "🎋" },
    { id: "tropical", name: "Tropikal", emoji: "🌴" },
    { id: "mediterranean", name: "Akdeniz", emoji: "🌊" },
    { id: "english", name: "İngiliz", emoji: "🌹" },
    { id: "zen", name: "Zen", emoji: "☯️" },
    { id: "cottage", name: "Kır Evi", emoji: "🏡" },
    { id: "desert", name: "Çöl", emoji: "🌵" },
];

export default function GardenStyleScreen() {
    ...
    const handleGenerate = () => {
        router.push({ pathname: "/loading", params: { action: "redesign" } });
    };
    ...
    return (
        <SafeAreaView className="flex-1 bg-background">
            <View className="flex-row items-center justify-between px-4 py-3">
                ...
                <Text className="text-lg font-semibold text-foreground">Bahçe Stili</Text>
            ...
            <ScrollView className="flex-1" contentContainerClassName="px-4 pb-32" showsVerticalScrollIndicator={false}>
                {originalImage && (
                    <View className="mb-6">
                        <Image source={{ uri: originalImage }} className="w-full h-48 rounded-3xl" resizeMode="cover" />
                    </View>
                )}

                <Text className="text-base font-semibold text-foreground mb-4">Bahçe Stili Seçin</Text>
            ...
            <View className="absolute bottom-0 left-0 right-0 bg-background px-4 pb-8 pt-4">
                <PillButton onPress={handleGenerate} disabled={!selectedStyle} fullWidth size="lg" icon={<Ionicons name="sparkles" size={20} color="#FFFFFF" />}>
                    Oluştur (8 Kredi)
                </PillButton>
            </View>
        </SafeAreaView>
