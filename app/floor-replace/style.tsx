...
const designStyles = [
    { id: "hardwood-light", name: "Açık Parke", emoji: "🪵" },
    { id: "hardwood-dark", name: "Koyu Parke", emoji: "🟤" },
    { id: "marble", name: "Mermer", emoji: "⬜" },
    { id: "tile-ceramic", name: "Seramik", emoji: "◻️" },
    { id: "concrete", name: "Beton", emoji: "🩶" },
    { id: "carpet", name: "Halı", emoji: "🧶" },
    { id: "laminate", name: "Laminat", emoji: "📋" },
    { id: "herringbone", name: "Balıksırtı", emoji: "〽️" },
];
    ...
    return (
        <SafeAreaView className="flex-1 bg-background">
            <View className="flex-row items-center justify-between px-4 py-3">
                ...
                <Text className="text-lg font-semibold text-foreground">Zemin Seçin</Text>
            ...
            <ScrollView className="flex-1" contentContainerClassName="px-4 pb-32" showsVerticalScrollIndicator={false}>
                ...
                <Text className="text-base font-semibold text-foreground mb-4">Zemin Türü Seçin</Text>
